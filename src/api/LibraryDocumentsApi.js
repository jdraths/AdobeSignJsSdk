...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/libraryDocuments/DocumentImageUrlsInfo', 'model/libraryDocuments/Documents', 'model/libraryDocuments/LibraryDocumentCreationInfoV6', 'model/libraryDocuments/LibraryDocumentCreationResponse', 'model/libraryDocuments/LibraryDocumentEventList', 'model/libraryDocuments/LibraryDocumentInfo', 'model/libraryDocuments/LibraryDocumentStateInfo', 'model/libraryDocuments/LibraryDocumentViewResponse', 'model/libraryDocuments/LibraryDocuments', 'model/libraryDocuments/LibraryViewInfo', 'model/libraryDocuments/Note', 'model/libraryDocuments/VisibilityInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/libraryDocuments/DocumentImageUrlsInfo'), require('../model/libraryDocuments/Documents'), require('../model/libraryDocuments/LibraryDocumentCreationInfoV6'), require('../model/libraryDocuments/LibraryDocumentCreationResponse'), require('../model/libraryDocuments/LibraryDocumentEventList'), require('../model/libraryDocuments/LibraryDocumentInfo'), require('../model/libraryDocuments/LibraryDocumentStateInfo'), require('../model/libraryDocuments/LibraryDocumentViewResponse'), require('../model/libraryDocuments/LibraryDocuments'), require('../model/libraryDocuments/LibraryViewInfo'), require('../model/libraryDocuments/Note'), require('../model/libraryDocuments/VisibilityInfo'));
  } else {
