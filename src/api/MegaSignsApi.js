...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/megaSigns/MegaSignChildAgreements', 'model/megaSigns/MegaSignCreationInfo', 'model/megaSigns/MegaSignCreationResponse', 'model/megaSigns/MegaSignStateInfo', 'model/megaSigns/MegaSignViewInfo', 'model/megaSigns/MegaSignViewResponse', 'model/megaSigns/MegaSigns', 'model/megaSigns/MegasignEventList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/megaSigns/MegaSignChildAgreements'), require('../model/megaSigns/MegaSignCreationInfo'), require('../model/megaSigns/MegaSignCreationResponse'), require('../model/megaSigns/MegaSignStateInfo'), require('../model/megaSigns/MegaSignViewInfo'), require('../model/megaSigns/MegaSignViewResponse'), require('../model/megaSigns/MegaSigns'), require('../model/megaSigns/MegasignEventList'));
  } else {
