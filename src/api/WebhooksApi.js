...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/webhooks/UserWebhooks', 'model/webhooks/WebhookCreationResponse', 'model/webhooks/WebhookInfo', 'model/webhooks/WebhookStateInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/webhooks/UserWebhooks'), require('../model/webhooks/WebhookCreationResponse'), require('../model/webhooks/WebhookInfo'), require('../model/webhooks/WebhookStateInfo'));
  } else {
